export default function ModeChooserScreen({ onChooseCloud, onChooseLocal }) {
  return (
    <main className="min-h-screen bg-[#0f1421] px-4 py-10 text-[#edf4ff]">
      <section className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-6xl flex-col justify-center gap-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 max-w-2xl text-lg leading-8 text-[#c8d3e3]">
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <article className="rounded-3xl border border-[#2b384d] bg-[#172031] p-6 shadow-2xl shadow-slate-950/25">
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-cyan-200">Local First</p>
            <h2 className="mt-3 text-2xl font-semibold text-[#edf4ff]">Try the product instantly</h2>
            <p className="mt-3 text-sm leading-7 text-[#c8d3e3]">
            ...
            <ul className="mt-5 space-y-2 text-sm text-[#c8d3e3]">
          ...
          <article className="rounded-3xl border border-[#2b384d] bg-[#172031] p-6 shadow-2xl shadow-slate-950/25">
            ...
            <h2 className="mt-3 text-2xl font-semibold text-[#edf4ff]">Set up hosted sync</h2>
            <p className="mt-3 text-sm leading-7 text-[#c8d3e3]">
